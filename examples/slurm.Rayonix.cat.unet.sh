#!/bin/bash
#
#SBATCH --job-name=pf.unet # Job name for allocation
...
## mpirun python -u -m mpi4py.run /reg/data/ana03/scratch/cwang31/drp/mpi.train.behenate.py
python train.fast.Rayonix.cat.unet.py
