...
class Predictor:
    ...
    def convert_mask_to_coord(self, batch_img, batch_mask_predicted):
        ...
        batch_mask_predicted = cp.asarray(batch_mask_predicted)

        # Sequeeze the fake channel dimension (dim = 1)...
        batch_mask_predicted = cp.squeeze(batch_mask_predicted, axis = 1)
    ...
    def calc_batch_center_of_mass(self, batch_mask):
        ...
        batch_center_of_mass = ndimage.center_of_mass(batch_mask, batch_label, cp.asarray(range(batch_num_feature)))
